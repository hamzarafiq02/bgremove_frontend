...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row gaper">
                    <div class="col-12 col-lg-6">
                        <div class="contact-main__thumb">
                            <div class="content">
                                <h2 class="h2 title wow fadeInUp" data-wow-duration="600ms" data-wow-delay="600ms">
                                    Have something in mind?
                                    Let's talk.
                                </h2>
                                <div class="paragraph wow fadeInUp" data-wow-duration="600ms" data-wow-delay="900ms">
                            ...
                            <div class="single-group wow fadeInUp" data-wow-duration="600ms" data-wow-delay="600ms">
                                <ul>
                                    ...
                                    <li><a href="mailto:company.info@mail.com"><i class="fa-solid fa-envelope"></i>info.stoky@company.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="contact-main__content">
                            <form action="#" method="post">
                                ...
                                <div class="group-radio">
                                    ...
                                    <label for="contactCheck">I accept your terms & conditions</label>
                                </div>
        ...
        <!-- ==== / contact section end ==== -->
        <!-- ==== faq section start ==== -->
        <section class="section faq-two faq-three">
            <div class="container">
                <div class="row gaper align-items-center">
                    <div class="col-12 col-lg-8">
                        <div class="faq-two__content">
                            ...
                            <div class="accordion" id="accordion">
                                <div class="accordion-item wow fadeInUp" data-wow-duration="600ms" data-wow-delay="300ms">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>
                                                Yes, the images are free, but the usage depends on the image
                                                license.
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-duration="600ms" data-wow-delay="600ms">
                                ...
                                <div class="accordion-item content__space wow fadeInUp" data-wow-duration="600ms" data-wow-delay="900ms">
                                ...
                                <div class="accordion-item content__space wow fadeInUp" data-wow-duration="600ms" data-wow-delay="1200ms">
                                ...
                                <div class="accordion-item content__space wow fadeInUp" data-wow-duration="600ms" data-wow-delay="1500ms">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="faq-two__thumb">
                            <img src="assets/images/faq-three-thumb.png" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- ==== / faq section end ==== -->
        <!-- google map -->
        <div class="map-wrapper wow fadeInUp" data-wow-duration="600ms" data-wow-delay="600ms">
            <iframe
        ...
        <footer class="section section--space-top footer gsap-fix-bottom">
            <div class="container">
                <div class="row gaper">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 col-xl-3">
                        <div class="footer__single wow fadeInUp" data-wow-duration="600ms" data-wow-delay="900ms">
